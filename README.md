...
4. Replace `template.png` with your own template image (it's recommended to pre-dither it using any tools beforehand)
5. Edit `placement.json` to configure the bot: set the coordinates for the template, enable unattended mode, choose a pixel selection algorithm.
